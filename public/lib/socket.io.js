...
/***/ function(module, exports) {
	...
	function short(ms) {
	  if (ms >= d) return Math.round(ms / d) + 'CANVAS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	Manager.prototype.open = Manager.prototype.connect = function (fn, opts) {
	  ...
	  if (false !== this._timeout) {
	    ...
	    debug('connect attempt will timeout after %CANVAS', timeout);

	    // set timer
	    var timer = setTimeout(function () {
	      debug('connect attempt timed out after %CANVAS', timeout);
	      openSub.destroy();
	      socket.close();
	...
	*/
	...
	Socket.prototype.flush = function () {
	  if ('closed' !== this.readyState && this.transport.writable &&
	    ...
	    debug('flushing %CANVAS packets in socket', this.writeBuffer.length);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Socket.prototype.emit = function (ev) {
	  ...
	  if ('function' === typeof args[args.length - 1]) {
	    debug('emitting packet with ack id %CANVAS', this.ids);
